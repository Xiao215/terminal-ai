...
class AlgoStrategy(gamelib.AlgoCore):
    def __init__(self):
        ...
        self.interceptor_destruct_strategy_wall  = [[20, 11], [21, 11], [22, 11], [23, 11], [24, 11], [25, 11], [20, 10], [20, 9], [21, 9], [22, 9], [23, 9]]
        self.interceptor_str_deploy = [[24, 10]] 
        
        self.more_wall_on_right = [[26, 13], [25, 12], [24, 11], [22, 9], [21, 8]]
...
# 3. The space below the five horizontal wall 
    ...
    def build_stage1_defences(self, game_state):
        ...
        wall_locations = [[0, 13], [1, 13], [2, 13], [3,13], [4,13], [5,13], [27, 13], [26, 12], [22,8],[25, 11], [24, 10], [23, 9], [21, 7], [20, 6], [19, 5], [18, 4], [17, 3], [16, 3],[15,3],[14,3],[13,3],[12,3],[11,4],[10,5],[9,6],[8,7],[7,8],[6,9],[7,10]]
        
        
        upgraded_wall_locations = [[0, 13], [1, 13], [2, 13], [3,13], [4,13], [5,13],[8,7],[6,9],[7,10]]
        wall_locations.remove(self.interceptor_str_deploy[0])
    ...
    def build_stage3_defence(self, game_state):
        ...
        if(count_of_first_support == 2):
            ...
            self.build_extra_turrets(game_state)
            self.build_second_supports(game_state)
    
    def build_extra_turrets(self, game_state):
    ...
    def trigger_attack(self, game_state):
        ...
        if(count_of_all_support >= 2 and count_of_all_support <= 4):
            if(my_MP >= 12):
                self.launch_attack_strong(game_state)
    ...
    def build_second_supports(self, game_state):
        ...
        # for location in self.more_wall_on_right:
        #     if self.get_SP(game_state, 0) <= 1.5:
        #         break
    ...
    def upgrade_turrets(self, game_state):
        ...
        game_state.attempt_upgrade(self.extra_turrets)
